...
class MatchingNet(AbstractMetaLearner):
    ...
    def set_forward(self, support_images, support_labels, query_images):
        ...
        if (self.training and self.use_train_query and self.transportation_module) or \
            ((not self.training) and self.use_test_query and self.transportation_module):
        ...
        support_labels = support_labels.to('cpu')
